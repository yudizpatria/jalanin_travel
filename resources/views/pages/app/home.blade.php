		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>Life is either <br> a daring adventure</h1>
					<p>lets find the best place for you location</p>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					<h2>Popular</h2>
					<p>Nikmati Pengalaman berlibur bersama tour terpercaya</p>
				</div>
			</div>
		</div>
		<div class="row">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="">
				<img class="card-img-top img-fluid" src="frontend/images/products/products-1.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
